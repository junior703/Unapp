...
public class EdifD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edif_d);
      ...
      //  floatingActionButton3 = (FloatingActionButton) findViewById(R.id.floating_linkdin);
        floatingActionButton4 = (FloatingActionButton) findViewById(R.id.labfran);
        floatingActionButton5 = (FloatingActionButton) findViewById(R.id.labing);
        floatingActionButton6 = (FloatingActionButton) findViewById(R.id.bibli);
...
//*********metodo para que tenga funcion lo botones flotantes*******//
        ...
        floatingActionButton4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(EdifD.this);
